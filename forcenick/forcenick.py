...
class ForceNick(commands.Cog):
    ...
    async def initialize(self):
        ...
        await self.bot.send_to_owners(
            "Forcenick is outdated and will be removed in August 2020 (this date has been moved forward due to discord and red guideline changes). Use NickNamer instead."
        )
